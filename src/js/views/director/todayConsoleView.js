...
import { buildStudentDrawerData, get30DaysRange } from './todayConsoleStudentDrawerData.js';
...
export function renderTodayConsole(container) {
    ...
    const triggerMessageHandoff = (taskId) => {
        triggerTodayConsoleMessageHandoff(taskId);
    };
    ...
    const renderDrawerContent = () => {
        ...
        try {
            ...
            if (student) {
                ...
                const data = buildStudentDrawerData({ student, stateStore, todayStr });
                if (data.error) {
